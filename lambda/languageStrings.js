    ...
    en: {
        translation: {
            ...
            [
                ...
                'In 2019, pull requests were made from all 483,127 participants!',
                'In 2019 over 150,000 repositories participated in the event!',
                'JavaScript was the most used language in Hacktoberfest 2019',
                'To get Hacktoberfest Swag this year, participants must register and make four valid pull requests between October 1-31',
                'Hacktoberfest has set up a discord under the name Hacktoberfest for participants to discuss and collaborate',
                'Digital Ocean launched Hacktoberfest in 2014 to encourage contribution to open source projects. 6 years into the future and Hacktoberfest has become a powerful force in driving contributions to open source',
                'This year, to limit their carbon impact, DigitalOcean is paying for carbon offsets. And to further help the environment, they’re offering the option to plant a tree rather than receive a shirt.',
                'Hacktoberfest shirts flew 336 million miles internationally in 2020. In total, it adds up to a fully loaded 747 flying 676 miles.',
            ],
        }
    },
    es: {
